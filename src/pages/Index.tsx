...
const Index = () => {
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative border-b-4 border-foreground">
        <div className="h-[400px] bg-cover bg-center relative" style={{
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          color: "bg-secondary"
        }].map((feature, index) => <div key={index} className="retro-border bg-card p-6 hover:translate-y-[-4px] transition-transform">
